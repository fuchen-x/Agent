...
def validate(model, epoch):
    ...
    stu_ability = net.get_knowledge_status(torch.arange(1, 2001, dtype=torch.long))
    print (stu_ability.shape)
    stu_ability = stu_ability.numpy()
    np.save("ability/epoch_" + str(epoch+1) + "_stu_ability.npy", stu_ability)
